...
| core span 오분해율 | `\|mention` | 0.0052 → **0.0052** (0.0) |
...
- decoy가 **후보로 올라온** mention: 172 — 0이면 이 시험은 무의미하다(decoy에 닿지도 못했다는 뜻)
- **decoy 확정(FP): 0건**
...
*측정 시점: commit `975056b`, 2026-09-01. 리포트와 코드가 어긋나면 코드가 맞다 — 재생성해서 확인할 것.*
