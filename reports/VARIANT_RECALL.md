...
| 이름 끝을 맞게 보고 (`name_span_exact`) | `\|mention` | 0.4673 → **0.9393** (+0.472) |
...
| `latin_suffix` | A | FORBIDDEN | 214 | 1.0 → **1.0** (0.0) | 1.0 | 0.0 | 1.0 | 214 → **214** (0) | 0 |
...
- 그중 `UNKNOWN` 판정: 562 → **562** (0) (카탈로그 확장 여지)
...
*측정 시점: commit `3aa61dd`, 2026-09-02. 리포트와 코드가 어긋나면 코드가 맞다 — 재생성해서 확인할 것.*
