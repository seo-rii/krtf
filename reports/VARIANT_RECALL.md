...
| `derivative_org` | A | FORBIDDEN | 214 | 1.0 → **1.0** (0.0) | 1.0 | 0.3312 | 1.0 | 108 → **108** (0) | 0 |
| `derivative_role` | A | FORBIDDEN | 214 | 1.0 → **1.0** (0.0) | 1.0 | 0.3896 | 1.0 | 88 → **88** (0) | 0 |
| `derivative_particle` | A | FORBIDDEN | 214 | 1.0 → **1.0** (0.0) | 1.0 | 0.3669 | 1.0 | 94 → **94** (0) | 0 |
| `org_unit` | A | FORBIDDEN | 214 | 1.0 → **1.0** (0.0) | 1.0 | 0.8571 | 1.0 | 135 → **32** (-103) | 0 |
| `artifact` | A | FORBIDDEN | 214 | 1.0 → **1.0** (0.0) | 1.0 | 0.8604 | 1.0 | 214 → **30** (-184) | 0 |
...
*측정 시점: commit `c71d196`, 2026-09-01. 리포트와 코드가 어긋나면 코드가 맞다 — 재생성해서 확인할 것.*
